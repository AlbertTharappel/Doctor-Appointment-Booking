	...
	<div class="container-fluid">
		<div class="row">
			...
			<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
				...
				<h2>Staff List</h2>
				<a href="staffreg" class="btn btn-success">Add+</a>
				<div class="table-responsive">
					<table class="table table-striped table-bordered mt-1">
						...
						<tbody>
							<c:forEach items="${staff}" var="s" varStatus="count">
								<tr class="text-center">
									<td>${count.index+1}</td>
									<td>${s.firstname}</td>
									<td>${s.lastname}</td>
									...
									<td>${s.email}</td>
									<td>${s.password}</td>
									<td><a href="edit/${s.id}" class="btn btn-primary badge">Edit</a>
										<a href="delete/${s.id}" class="btn btn-danger badge"
