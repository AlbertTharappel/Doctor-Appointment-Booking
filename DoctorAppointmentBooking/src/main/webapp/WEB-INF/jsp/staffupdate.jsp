							...
							<div class="card-body">
								...
								<form class="form-signin" action="../update" method="post">
									...
									<div class="form-group">
										<input type="hidden" name="id" value="${staff.id}"> <label>First
									...
									<div class="form-group">
										...
										<label>Age</label> <input type="text" name="age"
											value="${staff.age}" class="form-control" required="required">
									...
									<div class="form-group">
										...
										<label>Phone number</label> <input type="text"
											value="${staff.phonenumber}" name="phonenumber"
									...
									<div class="form-group">
										...
										<label>Email Address</label> <input type="email" name="email"
											value="${staff.email}" class="form-control"
											required="required">
									...
									<div class="form-group">
										...
										<label>Password</label> <input type="text"
											value="${staff.password}" name="password"
											class="form-control" required="required">

									</div>
									<div class="form-group">
										<label>UserType</label> <input type="text"
											value="${staff.usertype}" name="usertype"
											class="form-control" required="required">
									</div>
