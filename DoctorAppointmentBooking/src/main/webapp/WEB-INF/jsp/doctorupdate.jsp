							...
							<div class="card-body">
								...
								<form action="../update-doctor" method="post"
									...
									<div class="form-group">
										<input type="hidden" name="id" value="${doctor.id}"> <label>Image</label>

										<input type="file" name="file" accept="jpg"
											value="${doctor.image}" class="form-control"
											required="required">
									...
									<div class="form-group">
										...
										<label>First name</label> <input type="text" name="firstname1"
											value="${doctor.firstname1}" class="form-control"
											required="required">
									...
									<div class="form-group">
										...
										<label>Last name</label> <input type="text" name="lastname1"
											value="${doctor.lastname1}" class="form-control"
											required="required">
									...
									<div class="form-group">
										...
										<label>Department</label> <input type="text" name="speciality"
											value="${doctor.speciality}" class="form-control"
											required="required">
									...
									<div class="form-group">
										...
										<label>Qualification</label> <input type="text"
											value="${doctor.qualification }" name="qualification"
